...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[BussInfoViewController alloc] initWithNibName:@"BussInfoViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[BussInfoViewController alloc] initWithNibName:@"BussInfoViewController_iPad" bundle:nil];
    }
